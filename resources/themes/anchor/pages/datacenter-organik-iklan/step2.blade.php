        ...
        <div>
            ...
            <div class="flex mt-8">
                ...
                <div class="relative w-full">
                    ...
                    <img class="mt-2 max-w-xl rounded-lg shadow-xl dark:shadow-gray-800" src="{{ asset('images/shopee') }}/iklan-1.webp" alt="">
                    </div>
                </div>
                <div class="relative w-full">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="absolute -top-0.5 z-10 -ml-3.5 h-7 w-7 rounded-full text-black">
                    ...
                    <div class="ml-6">
                    <h4 class="font-bold text-black">3. Pilih Data Iklan produk</h4>
                    ...
                    <img class="mt-2 max-w-xl rounded-lg shadow-xl dark:shadow-gray-800" src="{{ asset('images/shopee') }}/iklan-2.webp" alt="">
                    </div>
                </div>
                <div class="relative w-full">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="absolute -top-0.5 z-10 -ml-3.5 h-7 w-7 rounded-full text-black">
                    ...
                    <div class="ml-6">
                    <h4 class="font-bold text-black">4. Tunggu proses selesai & Download File</h4>
                    ...
                    <img class="mt-2 max-w-xl rounded-lg shadow-xl dark:shadow-gray-800" src="{{ asset('images/shopee') }}/iklan-3.webp" alt="">
                    </div>
                </div>
                <div class="relative w-full">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="absolute -top-0.5 z-10 -ml-3.5 h-7 w-7 rounded-full text-black">
                    ...
                    <div class="ml-6">
                    <h4 class="font-bold text-black">5. Masuk ke Seller Center Shopee</h4>
                    ...
                    <x-button class="mt-2" tag="a" href="https://seller.shopee.co.id/portal/marketing/pas/index/?type=new_cpc_homepage&from={{$tglMulai}}&to={{$tglAkhir}}&group=custom&offset=360" target="_blank">Buka Seller Center Shopee</x-button>
                    </div>
                </div>
                <div class="relative w-full">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="absolute -top-0.5 z-10 -ml-3.5 h-7 w-7 rounded-full text-black">
                    ...
                    <div class="ml-6">
                    <h4 class="font-bold text-black">Hampir selesai, 1 langkah lagi.</h4>
